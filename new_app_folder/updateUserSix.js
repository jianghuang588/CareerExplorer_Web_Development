...
app.controller("myController", function($scope) {
  ...
  $scope.country=function () {
        DataToServer.infoClass2 = $scope.worker.country;
        DataToServer.action = "country";
        sendDataToServer();
  };

  $scope.money=function () {
        DataToServer.infoClass2 = $scope.worker.money;
        DataToServer.action = "money";
        sendDataToServer();
  };

  $scope.POPULATION=function () {
        DataToServer.infoClass2 = $scope.worker.POPULATION;
        DataToServer.action = "POPULATION";
        sendDataToServer();
  };
