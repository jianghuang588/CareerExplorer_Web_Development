...
app.controller("myController", function($scope) {
    ...
    setTimeout(function(){
        ...
        $scope.CITY = jsonDataFromServer.CITY;
...
function requestListener () {
    ...
    jsonDataFromServer.CITY = jsonObject.CITY;
...
// Sending and receiving information from the servlet to get the retire information.
function myBookClub($scope) {
    uid = getUID();
    DataToServer.infoClass1 = uid;
    DataToServer.action = "salary";
    // Debugging
